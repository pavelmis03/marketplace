...
urlpatterns = [
    ...
    path('password-reset/', include([
        ...
        path('complete/', views.PasswordResetCompleteView.as_view(), name='user.password.reset.complete'),
        path('<uidb64>/<token>/', views.PasswordResetConfirmView.as_view(), name='user.password.reset.confirm'),
    ])),
    path('password-change/', views.PasswordChangeView.as_view(), name='user.password.change'),
]
